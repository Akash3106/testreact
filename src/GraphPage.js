...
//   const {  nodes,edges,isLoadingTree, isLoadingTreeOnly } = useSelector(state=>state.mainSlice);
    const nodes = [ {id: 'ACCOUNTADMIN', label: 'ACCOUNTADMIN', level: 0, env: 'system'}
    ,{id: 'SECURITYADMIN', label: 'SECURITYADMIN', level: 1, env: 'system'}
    ,{id: 'SYSADMIN', label: 'SYSADMIN', level: 1, env: 'system'}
    ,{id: 'USERADMIN', label: 'USERADMIN', level: 3, env: 'system'}
    ,{id: 'DEV_FR_ALL_1', label: 'DEV_FR_ALL_1', level: 2, env: 'dev'}
    ,{id: 'DEV_FR_RW_ERT', label: 'DEV_FR_RW_ERT', level: 2, env: 'dev'}
    ,{id: 'DEV_FR_ALL_ROLE_TO_DROP', label: 'DEV_FR_ALL_ROLE_TO_DROP', level: 3, env: 'dev'}
    ,{id: 'DEV_FR_RO_DGF', label: 'DEV_FR_RO_DGF', level: 3, env: 'dev'}]



    const edges = [{id: 'NULL_ACCOUNTADMIN', source: 'NULL', target: 'ACCOUNTADMIN', label: 'NULL_ACCOUNTADMIN'}
    ,{id: 'ACCOUNTADMIN_SECURITYADMIN', source: 'ACCOUNTADMIN', target: 'SECURITYADMIN', label: 'ACCOUNTADMIN_SECURITYADMIN'}
    ,{id: 'ACCOUNTADMIN_SYSADMIN', source: 'ACCOUNTADMIN', target: 'SYSADMIN', label: 'ACCOUNTADMIN_SYSADMIN'}
    ,{id: 'SECURITYADMIN_USERADMIN', source: 'SECURITYADMIN', target: 'USERADMIN', label: 'SECURITYADMIN_USERADMIN'}
    ,{id: 'SYSADMIN_DEV_FR_ALL_1', source: 'SYSADMIN', target: 'DEV_FR_ALL_1', label: 'SYSADMIN_DEV_FR_ALL_1'}
    ,{id: 'SYSADMIN_DEV_FR_RW_ERT', source: 'SYSADMIN', target: 'DEV_FR_RW_ERT', label: 'SYSADMIN_DEV_FR_RW_ERT'}
    ,{id: 'DEV_FR_ALL_1_DEV_FR_ALL_ROLE_TO_DROP', source: 'DEV_FR_ALL_1', target: 'DEV_FR_ALL_ROLE_TO_DROP', label: 'DEV_FR_ALL_1_DEV_FR_ALL_ROLE_TO_DROP'}
    ,{id: 'DEV_FR_ALL_1_DEV_FR_RO_DGF', source: 'DEV_FR_ALL_1', target: 'DEV_FR_RO_DGF', label: 'DEV_FR_ALL_1_DEV_FR_RO_DGF'}
    ,{id: 'DEV_FR_ALL_1_USERADMIN', source: 'DEV_FR_ALL_1', target: 'USERADMIN', label: 'DEV_FR_ALL_1_USERADMIN'}]
    ...
    //       console.log("get_warehouses",response.data)
    //     }
    //   }
    //   catch(error){
    //     console.log(error)
    ...
    // console.log("Hi Edges-",edges,"& ref1-",ref1,"& ref2 -- ",ref2)
        ...
        // , height: "100%"
          ...
          <div className="nodes__div" style={{display: "flex", justifyContent: "center", flexDirection:"column",
            ...
            <div style={{display: "flex",justifyContent: "center",marginTop: "30px",}}>
              <Button startIcon={<RefreshIcon />} style={{"marginRight": "100px"}} onClick={refreshTree}
              >Refresh</Button><Button startIcon={<DownloadIcon />} onClick={() => {alert("Sorry. This feature is not yet supported.")}}>Download</Button>
            </div>
